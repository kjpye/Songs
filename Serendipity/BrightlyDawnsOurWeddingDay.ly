...
pianoLHone = \relative {
  ...
  \repeat volta 2 {
    ...
    <a c>2 <b d>8 r <g b> r
    c8 r r4 r2
%    <c,, c'>4 \vt \showStaffSwitch \change Staff = pianorh <e'' g> <d f> <g, d'> \hideStaffSwitch % 152b
    <c,, c'>4 \vt <e'' g> <d f> <g, d'> % 152b
    <c e>4 e <d f> <g, d'>
    c4 4 2 \vo % \change Staff = pianolh
    a4 fis g a
    s4 r <g, g'>2 \ov
    <c g'>4(bes' a g % 153a
    f4) r f f
