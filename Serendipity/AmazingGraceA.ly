...
%  piece       opus
  ...
  arranger    = "Arr. Lawrence Francis Bartlett (1933—2002)"
%  opus        = "opus"
...
alto = \relative {
  \autoBeamOff
  d'4 | b2 d4 | d2 c4 | b2 c4 | d2 c4 | b2 c4 |
  cis2 4 | d2(e4 | fis2) d4 | c2 g'4 | d2 4 |
  c4.(d8) e[c] | b2 4 | 2 cis4 | d2 c4 | b2(c4 | b2)
}

tenor = \relative {
  \autoBeamOff
  g4 | d2 g4 | g2 fis4 | e2 g4 | 2 fis4 | g2 4 |
  g2 4 | fis2(g4 | a2) fis4 | g2 4 | 2 4 |
  g2 4 | 2 4 | 2 4 | 4(e) e | g2(e4 | d2)
}

bass = \relative {
  \autoBeamOff
  g,4 | 2 8[b] | d2 4 | e2 c4 | b2 a4 | g2 d'4 |
  e2 4 | d2.~ | 2 4 | g,2 d'4 | b2 4 |
  c4.(b8) c[e] | g2 fis4 | e2 a,4 | d2 4 | g,2.~ | 2
}
