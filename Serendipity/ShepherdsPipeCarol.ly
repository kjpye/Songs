...
LyricsSopranoJointAbove = \lyricmode { % lyrics above sopranos
  _ _ _ _ _ _ _
  _ _ _ _ _ _ _
...
pianoRH = \relative c'' {
  ...
  s2 d'8-. bes-. g-. d'-. % 91b
  c8-. a-. f-. a-. bes-. g16(f e8) g-.
  c,4 f4\startTrillSpan f8-. \stopTrillSpan f'-. c-. a-.
%  \bar "|."
}
      ...
      <<
        \new ChoirStaff <<
          ...
          \new Staff \with { instrumentName = #"Tenor" shortInstrumentName = #"T" } <<
            \clef "treble_8"
            \new Voice = "tenorsingleone" { \voiceOne \tenorSeparateOne }
            \new Voice = "tenorsingletwo" { \voiceTwo \tenorSeparateTwo }
          ...
          \new Staff = staffJointSopranoAlto \with { instrumentName = #"Soprano/Alto" shortInstrumentName = #"SA" } <<
            ...
            \new Lyrics \with { alignAboveContext = staffJointSopranoAlto } { \lyricsto sopranojoint \LyricsSopranoJointAbove }
          >>
    ...
    \context GrandStaff <<
      <<
        \new ChoirStaff <<
          ...
          \new Staff \with { instrumentName = #"Bass" shortInstrumentName = #"B" } <<
            \clef "bass"
            \new Voice = "bass" \unfoldRepeats \bassSeparate
            \new Lyrics \lyricsto "bass" \wordsBass
          >>
                                % Joint soprano/alto staff
