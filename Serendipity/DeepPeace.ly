...
soprano = \relative c' {
  ...
  ees8^\markup\bold "Women only" f g aes bes4
  bes2.
  aes8 g aes bes c d
  ees2.
  d8 c c4. ees8
  ...
  \time 4/4 g4^\markup\bold Tutti 4~8 16 16 8 aes
  \time 3/4 g8. f16 2
  ...
  c2(bes)\breathe
  g4 2 4
  c2^\markup\italic "2 optional bars a capella" (bes) \breathe
  g4 2 4 |
  g1-\fermata
  \bar "|."
}
...
tenor = \relative c {
  \global
  \voiceOne
  ees1^\markup\bold "Men only"
  d1
  c2 bes
  \time 5/4 bes1 \oneVoice r4 \voiceOne
  \time 4/4 ees4^\markup\bold Tutti  ees~ees8 ees16 ees16 ees8 ees
  \time 3/4 f8. f16 f2
