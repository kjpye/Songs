...
%  dedication  = "dedication"
  ...
  subtitle    = "From Ariel’s Song, The Tempest"
...
soprano = \relative {
  ...
  e4 fis2-> a4-> ~ | a d2.-> | <<{\vo d2-> e-> | fis1\fermata} \new Voice {\vt d2. cis4 | d1\fermata} >>
...
alto = \relative {
  ...
  <<
    {\vt d2-> e-> | fis-> a-> | d,-> g-> | fis1\fermata |}
    \new Voice {\vo R1 | d2 e4(fis) | b2. a4 | a1\fermata}
  >>
  \bar "|."
}
