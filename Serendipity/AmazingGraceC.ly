...
%  dedication  = "dedication"
  title       = "Amazing Grace"
  subtitle    = "Churches of Christ Hymn Book 596"
...
soprano = \relative {
  \autoBeamOff
  d'4 | g2 b8[g] | b2 a4 | g2 e4 | d2 4 |
  g2 b8[g] | b2 a4 | d2 \section b4 | d4.(b8) d[b] | g2 d4 |
  e4.(g8) g[e] | d2 4 | g2 b8[g] | b2 a4 | g2
}

alto = \relative {
  \autoBeamOff
  c'4 | b2 d4 | d2 4 | b2 c4 | b2 c4 |
  b2 d4 | 2 4 | 2 \section 4 | g2 4 | d2 4 |
  c2 4 | b2 d4 | 2 e4 | d2 c4 | b2
}

tenor = \relative {
  \autoBeamOff
  f4 | g2 4 | 2 f4 | g2 4 | 2 f4 |
  g2 4 | g2 f4 | g2 \section 4 | b2 8[g] | 2 4 |
  g2 e8[g] | 2 f4 | g2 4 | g2 f4 | g2
}

bass = \relative {
  \autoBeamOff
  d4 | g,2 4 | d'2 4 | e2 c4 | b2 a4 |
  g2 4 | d'2 c4 | b2 \section g4 | g'2 4 | b,2 4 |
  c2 4 | g2 a4 | b2 c4 | d2 4 | g,2
}
